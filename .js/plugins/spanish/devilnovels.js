                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (entry && entry.length) {
                            ...
                            clone.find('.elementor-posts-container, .elementor-posts, .elementor-post, .elementor-pagination, .code-block, iframe, script, style, .ad, .adsbygoogle, .post-list, .chapter-list').remove();
                            ...
                            if (cleanedText) {
                                ...
                                firstP = entry.find('p').filter(function (i, el) { return $(el).text().trim(); }).first();
