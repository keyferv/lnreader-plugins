...
var DevilNovels = /** @class */ (function () {
    ...
    DevilNovels.prototype.parseNovel = function (novelPath) {
        return __awaiter(this, void 0, void 0, function () {
            var url, res, body, $, novel, seen, pageLinks, uniquePageLinks, _loop_1, this_1, _i, uniquePageLinks_1, pageUrl;
            var _this = this;
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        $('.elementor-posts-container article, .elementor-post').each(function (i, el) {
                            var block = $(el);
                            var a = block.find('h3.elementor-post__title a, h3.elementor-post__title > a, a[data-wpel-link="internal"]').first();
                            var href = a.attr('href') || '';
                            var text = a.text().trim();
                            if (!href || !text)
                                return;
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        ...
                                        if (normalizedPageUrl === (url) || normalizedPageUrl === (this_1.site + novelPath))
                                            return [2 /*return*/, "continue"];
                                        _b.label = 1;
                                    case 1:
                                        _b.trys.push([1, 5, , 6]);
