...
var LightNovelWPPlugin = /** @class */ (function () {
    ...
    LightNovelWPPlugin.prototype.parseChapter = function (chapterPath) {
        return __awaiter(this, void 0, void 0, function () {
            var data, $, url, offsets, idx, _a, _, offsetLower_1, offsetCap_1, asciiA_1, asciiz_1;
            var _b, _c, _d, _e;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 1:
                            ...
                            try {
                                ...
                                $('div.entry-content > p').text(function (_, txt) {
                                    return txt.split('').map(function (char) {
                                        ...
                                        var offset = (code >= offsetLower_1 + asciiA_1 && code <= offsetLower_1 + asciiz_1)
                                            ? offsetLower_1
                                            : offsetCap_1;
                        ...
                        return [2 /*return*/, (((_e = (_d = data
                                .match(/<div.*?class="epcontent ([^]*?)<div.*?class="?bottomnav/g)) === null || _d === void 0 ? void 0 : _d[0].match(/<p[^>]*>([^]*?)<\/p>/g)) === null || _e === void 0 ? void 0 : _e.join('\n')) || '')];
                }
            });
        });
    };
