...
var StorySeedlingPlugin = /** @class */ (function () {
    ...
    StorySeedlingPlugin.prototype.updateNonce = function (chapterPath) {
        return __awaiter(this, void 0, void 0, function () {
            var $;
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        $ = _c.sent();
                        this.nonce = (_b = (_a = $('div.mb-4:has(h1.text-xl) > div')
                            .attr('x-data')) === null || _a === void 0 ? void 0 : _a.match(/loadChapter\('.+?', '(.+?)'\)/)) === null || _b === void 0 ? void 0 : _b[1];
                        return [2 /*return*/];
                }
            });
        });
    ...
    StorySeedlingPlugin.prototype.parseChapter = function (chapterPath) {
        return __awaiter(this, void 0, void 0, function () {
            var updatedNonce, text, textJson, html, $;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        updatedNonce = !this.nonce;
                        if (!!this.nonce) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.updateNonce(chapterPath)];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [4 /*yield*/, (0, fetch_1.fetchApi)(this.site + chapterPath + '/content', {
                            method: 'POST',
                            headers: {
                    ...
                    case 3:
                        ...
                        if (!(textJson && !textJson.success)) return [3 /*break*/, 6];
                        if (!(textJson.message === 'Invalid security.')) return [3 /*break*/, 5];
                        if (updatedNonce) {
                            throw new Error("Failed to find code!");
                        }
                        this.nonce = '';
                        return [4 /*yield*/, this.parseChapter(chapterPath)];
                    case 4: return [2 /*return*/, _a.sent()];
                    case 5:
                        if (textJson.captcha) {
                            throw new Error("Failed to bypass turnstile captcha (read in webview until it stops ig)");
                        }
                        _a.label = 6;
                    case 6:
                        html = text
                            ...
                            var offset = code > 12123 ? 12027 : 12033;
                        ...
                        $('span').text(function (_, txt) {
                            return txt.toLowerCase().includes('storyseedling') ||
