...
var FenrirRealmPlugin = /** @class */ (function () {
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        genresFilter = filters.genres.value
                            ...
                            .join('');
                        return [4 /*yield*/, (0, fetch_1.fetchApi)("".concat(this.site, "/api/series/filter?page=").concat(pageNo, "&per_page=20&status=").concat(filters.status.value, "&order=").concat(sort).concat(genresFilter)).then(function (r) {
    ...
    FenrirRealmPlugin.prototype.parseNovel = function (novelPath) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, fetch_1.fetchApi)("".concat(this.site, "/series/").concat(novelPath), {}).then(function (r) { return r.text(); })];
                    case 1:
                        html = _a.sent();
                    ...
                    case 2:
                        ...
                        novel.chapters = chapters
                            ...
                            return ({
                                ...
                                chapterNumber: c.number + (((_f = c.group) === null || _f === void 0 ? void 0 : _f.index) || 0) * 1000000000000,
                            });
                        })
    ...
    FenrirRealmPlugin.prototype.parseChapter = function (chapterPath) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, fetch_1.fetchApi)(this.site + '/series/' + chapterPath, {}).then(function (r) { return r.text(); })];
                    case 1:
                        page = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, fetch_1.fetchApi)("".concat(this.site, "/api/series/filter?page=").concat(pageNo, "&per_page=20&search=").concat(encodeURIComponent(searchTerm)))
                            ...
                            .then(function (r) {
                            return r.data.map(function (novel) { return _this.parseNovelFromApi(novel); });
                        })];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    data = _a.sent();
                    genreData = data.map(function (g) { return ({
                        label: g.name,
                        value: g.id.toString(),
                    }); });
