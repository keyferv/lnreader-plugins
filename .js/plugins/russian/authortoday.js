...
var AuthorToday = /** @class */ (function () {
    ...
    AuthorToday.prototype.parseChapter = function (chapterPath) {
        return __awaiter(this, void 0, void 0, function () {
            var html, parts, workID, chapterID, userRaw, userId, chapter, chapterJson, key, chapterText;
            var _a, _b, _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        workID = parts[0];
                        chapterID = parts[1];
                        userRaw = (_b = (_a = html.match(/userId:(.*?),/)) === null || _a === void 0 ? void 0 : _a[1]) === null || _b === void 0 ? void 0 : _b.trim();
                        userId = userRaw === 'null' ? '' : userRaw;
                        if (!chapterID) {
                            chapterID = ((_d = (_c = html.match(/chapterId:(.*?),/)) === null || _c === void 0 ? void 0 : _c[1]) === null || _d === void 0 ? void 0 : _d.trim()) || '';
                        }
                        if (!chapterID)
