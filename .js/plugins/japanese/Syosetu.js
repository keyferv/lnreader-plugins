                        ...
                        getNovelsFromPage = function (pagenumber) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 2:
                                        html = _a.sent();
                                        loadedCheerio = loadCheerio(html, {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        body = _b.sent();
                        loadedCheerio = loadCheerio(body, { decodeEntities: false });
                        status = 'Unknown';
                    ...
                    case 4:
                        ...
                        pageResults.forEach(function (pageBody) {
                            var pageCheerio = loadCheerio(pageBody, {
                                decodeEntities: false,
                            });
                        ...
                        getNovelsFromPage = function (pagenumber) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 2:
                                        body = _a.sent();
                                        cheerioQuery = loadCheerio(body, { decodeEntities: false });
                                        pageNovels = [];
